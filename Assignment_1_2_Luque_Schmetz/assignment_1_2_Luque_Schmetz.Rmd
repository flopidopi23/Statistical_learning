...
title: "Eigenfaces"
output: pdf_document
author: "Simon Schmetz and Florencia Luque"
date: "2025-02-12"
---
...
estimate_threshold_via_percentile <- function(data, percentile = 0.90, distance_metric = "euclidean") {
  ...
  threshold <- quantile(dist_1[upper.tri(dist_1)], percentile) # *1.5 would be an option to increase threshold ranage
